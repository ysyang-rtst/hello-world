...
public class BowlingPackageImpl extends EPackageImpl implements BowlingPackage {
	 ...
	 */
	@Override
	public EAttribute getPlayer_IsProfessinal() {
	...
	public void createPackageContents() {
		...
		createEAttribute(playerEClass, PLAYER__IS_PROFESSINAL);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getPlayer_IsProfessinal(), ecorePackage.getEBoolean(), "isProfessinal", null, 0, 1, Player.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getMatchup_Games(), this.getGame(), null, "games", null, 0, 2, Matchup.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
