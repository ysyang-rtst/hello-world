...
public class PlayerItemProvider 
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addIsProfessinalPropertyDescriptor(object);
		}
	...
	/**
	 * This adds a property descriptor for the Is Professinal feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addIsProfessinalPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Player_isProfessinal_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Player_isProfessinal_feature", "_UI_Player_type"),
				 BowlingPackage.Literals.PLAYER__IS_PROFESSINAL,
				 true,
				 false,
				 false,
